...
const Bookmarks = () => {
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div id='bookmarks' className="container pt-10 pb-20 min-h-[70dvh] flex items-start gap-10 border-t border-slate-400/30 relative">
        <div className="flex-[1_1_20%] sticky top-12 z-10">
          ...
          <div className="relative">
            <span className='absolute -left-10 -bottom-60 z-0 w-60 aspect-square rounded-full bg-indigo-600/50 blur-[100px]' />
          </div>
        </div>
        <div className="flex-[1_1_80%] z-10">
          <h4 className='text-2xl font-bold bg-gradient-1 text-transparent bg-clip-text capitalize'>Bookmarks <span className='text-slate-400 lowercase font-normal'>- {activeLabel}</span></h4>
