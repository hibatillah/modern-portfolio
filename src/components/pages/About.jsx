  ...
  return (
    <>
      ...
      <div className="container py-10 flex items-start gap-10 border-t border-slate-400/30">
        <div className="flex-1 flex gap-6 items-start text-lg">
          ...
          <div className="flex flex-col gap-5 relative">
            ...
            <a href={CV} download="CV Hibatillah" className='w-fit'>
              <button className='w-52 px-8 py-2 flex flex-nowrap justify-center items-center gap-3 rounded-lg bg-gradient-2 text-lg font-semibold text-white active:brightness-90 overflow-hidden group z-10'>
