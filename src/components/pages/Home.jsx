        ...
        <div className="col-span-3 flex flex-col">
          <Heading 
            ...
            <div className="w-fit flex gap-4 items-center mt-8">
              ...
              <a href="https://drive.google.com/file/d/1-1VmjgKE1JAtnofOF1U2s12Es3tCZWAi/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                <button className='px-8 py-2 flex justify-center items-center gap-2 rounded-full border-label-2 text-lg font-semibold text-white transition-colors duration-300 hover:bg-gradient-2 active:brightness-90 overflow-hidden'>
